...
export default function LoadingModal() {
    ...
    return (
        <div className="modal-background z-30 fixed h-screen w-screen bg-gray-400 bg-opacity-80 flex justify-center">
            <div className="modal flex flex-col justify-center items-center bg-white p-8 m-auto w-2/3 min-w-[300px]">
                ...
                <caption className="mt-4 text-lg text-green md:text-xl xl:text-3xl"><FormattedMessage id="recipes.generating" /><span id="loading-dots">
                    {dots}
                </span></caption>
            </div>
        </div>
