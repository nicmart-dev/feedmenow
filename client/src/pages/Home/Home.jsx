export default function Home() {
    ...
    return (
        <>
            ...
            <form className="border rounded-md p-2">
            ...
            <div className="mt-6 mb-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8 border rounded-md p-2">
                {recipes.map((recipe) => (
